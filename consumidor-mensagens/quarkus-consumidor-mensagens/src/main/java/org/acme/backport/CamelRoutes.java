...
/*
 * Permite testar esse projeto com um curl, ex: curl -XPOST http://localhost:8050/api/registration -H "Content-Type: application/json" -d '{ "event" : "123" , "guest" : "John" }'
 */
@ApplicationScoped
public class CamelRoutes extends RouteBuilder {
    ...
    public void configure() {
        ...
        .unmarshal(new JacksonDataFormat(Registration.class))
